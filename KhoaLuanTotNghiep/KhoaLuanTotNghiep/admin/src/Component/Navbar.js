        ...
        {(value) => (
          <aside className="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" className="brand-link">
              ...
              <p className="brand-text font-weight-light" >Bất Động Sản </p>
            ...
            <div className="sidebar">
              ...
              <div className="user-panel mt-3 pb-3 mb-3 d-flex">
                <div className="info">
                  <img src="https://vnwriter.net/wp-content/uploads/2017/05/emotion-2.jpg" href="/" style={{ height: "100%", width: "100%", backgroundColor: "yellow" }}></img>
                </div>
              </div>
