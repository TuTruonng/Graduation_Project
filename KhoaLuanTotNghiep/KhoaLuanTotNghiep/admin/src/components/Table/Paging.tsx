...
const Paging: React.FC<PageType> = ({ currentPage = 1, totalPages = 1, handleChange }) => {
    const prePageStyle = currentPage !== 1 ? 'pagination__link' : 'pagination__link link-disable';
    const nextPageStyle = currentPage + 1 <= totalPages ? 'pagination__link' : 'pagination__link link-disable';
